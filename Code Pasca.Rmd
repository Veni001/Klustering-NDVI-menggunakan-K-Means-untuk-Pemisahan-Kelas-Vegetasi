...
```{r}
b4<-rast("C:/Users/mafad/Downloads/ADSp_TB/Ogan Komering Ilir_Terkoreksi/RT_LC09_L1TP_124062_20230928_20230928_02_T1_B4.TIF")
b5<-rast("C:/Users/mafad/Downloads/ADSp_TB/Ogan Komering Ilir_Terkoreksi/RT_LC09_L1TP_124062_20230928_20230928_02_T1_B5.TIF")
...
kmeans_NDVI_raster[df_NDVI$cell]<-NDVI_kmeans$cluster
```

```{r}
plot(kmeans_NDVI_raster, 
     main="Klustering NDVI Pedamaran Timur Pasca Kebakaran dengan 2 Kluster", 
     col=c("blue", "red"), 
     colNA="black")
legend("bottomright", legend=c("MV", "DV"), fill=c("blue", "red"), title="Kluster", cex=0.7, inset=c(0.1, 0.1))
```
